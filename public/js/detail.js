...
const updateCart = (product) => {
    let positionThisProductInCart = carts.findIndex(cartItem => cartItem.ProductID == product.ProductID);

    if (carts.length <= 0 || positionThisProductInCart < 0) {
        carts.push({ ProductID: product.ProductID, Name: product.Name, Price: product.Price, quantity: 1 });
    } else {
